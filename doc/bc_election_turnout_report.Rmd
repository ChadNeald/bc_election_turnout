...
The pvp dataset, as the name suggests, includes the number of votes as well as the number of registered voters all broken down by election and election district. With this information, we can calculate the turnout rate per election district per election.
